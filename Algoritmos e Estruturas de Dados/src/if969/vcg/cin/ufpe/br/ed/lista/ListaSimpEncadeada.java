...
public class ListaSimpEncadeada<Elemento> implements Lista<Elemento> {
	...
	/**
	 * Metodo para retornar a Lista Encadeada como uma Pilha
	 * @return Pilha
	 */
	public Pilha<Elemento> retornaPilha() {
		...
		Nodo<Elemento> aux = cabeca;
		while(aux.getProximo() != null) {
			pilha.push(aux.getProximo().getElemento());
			aux = aux.getProximo();
		}
		return pilha;
	}
	...
	/**
	 * Metodo para retornar a Lista Encadeada como uma Fila
	 * @return
	 */
	public Fila<Elemento> retornaFila() {
		...
		Nodo<Elemento> aux = cabeca;
		while(aux.getProximo() != null) {
			fila.enqueue(aux.getProximo().getElemento());
			aux = aux.getProximo();
		}
		return fila;
	}
